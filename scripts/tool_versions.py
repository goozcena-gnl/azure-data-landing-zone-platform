...
RULES = (
    ...
    VersionRule("TERRAFORM_LINUX_AMD64_SHA256", ".github/workflows/validate.yml", r"^\s*TERRAFORM_SHA256:\s*([0-9a-f]{64})\s*$"),
    VersionRule("TERRAFORM_LINUX_AMD64_SHA256", ".github/workflows/deploy-lab.yml", r"^\s*TERRAFORM_SHA256:\s*([0-9a-f]{64})\s*$"),
    VersionRule("TERRAFORM_LINUX_AMD64_SHA256", ".github/workflows/destroy-lab.yml", r"^\s*TERRAFORM_SHA256:\s*([0-9a-f]{64})\s*$"),
    VersionRule("TERRAFORM_LINUX_AMD64_SHA256", ".azuredevops/azure-pipelines.yml", r"^\s*terraformLinuxAmd64Sha256:\s*'([0-9a-f]{64})'\s*$"),
    ...
    VersionRule("PYTHON_SERIES", "docs/local-development.md", r"\| Python series \| ([0-9.]+)\.x \|"),
    VersionRule("PYTHON_TESTED_VERSION", "docs/local-development.md", r"\| Python tested patch \| ([0-9.]+) \|"),
    VersionRule("NODE_VERSION", "docs/local-development.md", r"\| Node\.js \| ([0-9.]+) \|"),
    VersionRule("NPM_VERSION", "docs/local-development.md", r"\| npm \| ([0-9.]+) \|"),
    ...
    VersionRule("TRIVY_VERSION", "docs/local-development.md", r"\| Trivy \| ([0-9.]+) \|"),
